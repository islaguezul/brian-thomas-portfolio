...
import ContentCrossTenantPanels from '@/components/admin/ContentCrossTenantPanels';
...
export default async function ContentPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Cross-Tenant Copy Panels */}
      <ContentCrossTenantPanels
        currentTechStack={techStack}
        currentSkillCategories={skillCategories}
        currentProcessStrategies={processStrategies}
      />
